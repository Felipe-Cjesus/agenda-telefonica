...
int main(){
    ...
    //o la�o de repeti��o serve para manter a comunica��o com o usu�rio atrav�s do menu a a op��o escolhida pelo usu�rio
    while(true){
	   	menu();
    	cout << "Opcao - ";
       	cin >> opcao;
       
       //define a escolha do usu�rio
       if(opcao == 0){
           break;
       }else if(opcao == 1){
           if(!map_agenda.empty()){
        ...
        system("pause");
           ...
           //verifica se o n�mero do telefone j� existe no mapa
           ...
           if(it != map_agenda.end()){
	           	...
	           	if(subst!=1){
			   		...
			   		//Fun��o que substitui caso o numero da chave for igual
			  	 	map_agenda.insert(make_pair(num , pessoa(nome, sobrenome)));
			  	 	continue;
			   }
       		//insere o dado no mapa, se existir, ir� substituir
